...
<form method="POST" action="/listings/add" enctype="multipart/form-data">
    @csrf
    <div class="mb-6">
        <label
            for="title"
    ...
    <div class="mb-6">
        ...
        <input
            ...
            class="border border-gray-200 rounded p-2 w-full"
            name="chapter"
            placeholder="Example: Page number/Chapter"
            value="{{old('chapter')}}"
        />
        @error('chapter')
        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
    ...
    <div class="mb-6">
        ...
        <input
            ...
            class="border border-gray-200 rounded p-2 w-full"
            name="genre"
            placeholder="Example: Action, adventure"
            value="{{old('genre')}}"
        />
        @error('genre')
        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
    ...
    <div class="mb-6">
        ...
        <input
            ...
            class="border border-gray-200 rounded p-2 w-full"
            name="link"
            placeholder="Example: https://www.link.com"
            value="{{old('link')}}"
        />
        @error('link')
        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
